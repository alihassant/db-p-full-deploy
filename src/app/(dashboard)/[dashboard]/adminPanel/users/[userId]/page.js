    ...
    try {
      ...
      if (response) {
        ...
        if (user) {
          ...
          INITIAL_EDIT_DETAILS.currentPlan = user.currentPlan;
          INITIAL_EDIT_DETAILS.extraRole = user.extraRole;
                      ...
                      <form>
                        ...
                        <div className="row">
                          <div className="col">
                            <div className="mb-3">
                              <label className="form-label">
                                <strong>Current Role: {user.extraRole}</strong>
                              </label>
                            </div>
                          </div>
                          <div className="col">
